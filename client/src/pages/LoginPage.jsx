...
function LoginPage() {
  ...
  const handleSubmit = async () => {
    try {
      setLoading(true);
      const res = await axios.post(`https://notes-app-production-eb4a.up.railway.app/api/auth/login`, form);
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.link}>Don't have an account? <a href="/signup" style={styles.a}>Sign Up</a></p>
      </div>
    </div>
  );
}
